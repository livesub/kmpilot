<?php
    ...
    $query = "SELECT * FROM $board WHERE BB_id='$_GET[id]'";//부모글을 가져옴.
    $parent_result = SqlQuery($conn, $query);
    $parent_row = SqlFatchArray($parent_result);
    $parent_title = "RE:" . $parent_row[BB_title];//RE : 를 앞에 붙여줌
    $parent_content = "\n>" . str_replace("\n", "\n>", $parent_row[BB_content]);    
?>
...
<tr>
        ...
        <INPUT type=submit value="답글 저장하기">
