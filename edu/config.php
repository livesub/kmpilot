...
define('PORTAL_LIB_PATH', $_SERVER['DOCUMENT_ROOT'].'/portal/lib');
...
define('G5_BOARD_PORTAL_SKIN_DIR', 'portal');
define('G5_ADMIN_DIR',      'adm');
define('G5_EDU_DIR',        'edu');
...
define('G5_BOARD_PORTAL_SKIN_URL',      $_SERVER['HTTP_HOST'].'/portal');
define('G5_EDU_URL',        G5_URL.'/'.G5_EDU_DIR);
...
//혹시 모를 회원 이관 작업을 위해 암호화를 md5 로 변경
