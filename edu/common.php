...
*/
    $board_skin_path    = get_skin_path2('board', $board['bo_skin']);
    $board_skin_url     = get_skin_url2('board', $board['bo_skin']);
    $member_skin_path   = get_skin_path2('member', $config['cf_member_skin']);
