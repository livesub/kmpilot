...
<section id="bo_w">
    ...
    <div class="bo_w_flie write_div">
        <div class="file_wr write_div">
            ...
            <input type="file" name="bf_file[]" id="bf_file_<?php echo $i+1 ?>" title="파일첨부 <?php echo $i+1 ?> : 용량 <?php echo $upload_max_filesize ?> 이하만 업로드 가능" class="frm_file " <?php if($w != 'u') echo "required"; ?>>
        </div>
    ...
    <div class="btn_confirm write_div">
        <a href="<?php echo strpos($_SERVER['SCRIPT_NAME'],'adm')? get_pretty_url_admin($bo_table) : get_pretty_url($bo_table); ?>" class="btn_cancel btn">취소</a>
