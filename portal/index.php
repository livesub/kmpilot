        ...
        <div class="contents inlineBlock">
            <div>
                <div>
                    <div class="box-title">
                        <ul>
                            <li class="active" onclick="showBranch(0)">부산</li><li onclick="showBranch(1)">여수</li><li onclick="showBranch(2)">인천</li><li onclick="showBranch(3)">울산</li><li onclick="showBranch(4)">평택</li><li onclick="showBranch(5)">마산</li><li onclick="showBranch(6)">대산</li><li onclick="showBranch(7)">포항</li><li onclick="showBranch(8)">군산</li><li onclick="showBranch(9)">목포</li><li onclick="showBranch(10)">동해</li><li onclick="showBranch(11)">제주</li>
                        </ul>
                    </div>
                    <div class="box-contents">
                        <div>
                            <div class="title">
                                <div>부산항 도선사회<br/><span>협회장 최상문</span></div>
                                <div>
                                    <img src="<?=G5_PUBLISH_URL?>/resources/branches/busan.jfif" alt="">
                                </div>
                            </div>
                            <div class="contents">
                        ...
                        <div class="hide">
                            <div class="title">
                                <div>여수항 도선사회<br/><span>협회장 임형도</span></div>
                                <div>
                                    <img src="<?=G5_PUBLISH_URL?>/resources/branches/yeosu.jfif" alt="">
                                </div>
                            </div>
                            <div class="contents">
                        ...
                        <div class="hide">
                            <div class="title">
                                <div>인천항 도선사회<br/><span>협회장 하용구</span></div>
                                <div>
                                    <img src="<?=G5_PUBLISH_URL?>/resources/branches/incheon.jfif" alt="">
                                </div>
                            </div>
                            <div class="contents">
                        ...
                        <div class="hide">
                            <div class="title">
                                <div>울산항 도선사회<br/><span>협회장 전필호</span></div>
                                <div>
                                    <img src="<?=G5_PUBLISH_URL?>/resources/branches/ulsan.jfif" alt="">
                                </div>
                            </div>
                            <div class="contents">
                        ...
                        <div class="hide">
                            <div class="title">
                                <div>평택항 도선사회<br/><span>협회장 전복연</span></div>
                                <div>
                                    <img src="<?=G5_PUBLISH_URL?>/resources/branches/pyeongtaek.jfif" alt="">
                                </div>
                            </div>
                            <div class="contents">
                        ...
                        <div class="hide">
                            <div class="title">
                                <div>마산항 도선사회<br/><span>협회장 조영균</span></div>
                                <div>
                                    <img src="<?=G5_PUBLISH_URL?>/resources/branches/masan.jfif" alt="">
                                </div>
                            </div>
                            <div class="contents">
                        ...
                        <div class="hide">
                            <div class="title">
                                <div>대산항 도선사회<br/><span>협회장 정준권</span></div>
                                <div>
                                    <img src="<?=G5_PUBLISH_URL?>/resources/branches/daesan.jfif" alt="">
                                </div>
                            </div>
                            <div class="contents">
                        ...
                        <div class="hide">
                            <div class="title">
                                <div>포항항 도선사회<br/><span>협회장 최만택</span></div>
                                <div>
                                    <img src="<?=G5_PUBLISH_URL?>/resources/branches/pohang.jfif" alt="">
                                </div>
                            </div>
                            <div class="contents">
                        ...
                        <div class="hide">
                            <div class="title">
                                <div>군산항 도선사회<br/><span>협회장 승병준</span></div>
                                <div>
                                    <img src="<?=G5_PUBLISH_URL?>/resources/branches/gunsan.jfif" alt="">
                                </div>
                            </div>
                            <div class="contents">
                        ...
                        <div class="hide">
                            <div class="title">
                                <div>목포항 도선사회<br/><span>협회장 박재화</span></div>
                                <div>
                                    <img src="<?=G5_PUBLISH_URL?>/resources/branches/mokpo.jfif" alt="">
                                </div>
                            </div>
                            <div class="contents">
                        ...
                        <div class="hide">
                            <div class="title">
                                <div>동해항 도선사회<br/><span>협회장 정춘호</span></div>
                                <div>
                                    <img src="<?=G5_PUBLISH_URL?>/resources/branches/donghae.jfif" alt="">
                                </div>
                            </div>
                            <div class="contents">
                        ...
                        <div class="hide">
                            <div class="title">
                                <div>제주항 도선사회<br/><span>협회장 박윤영</span></div>
                                <div>
                                    <img src="<?=G5_PUBLISH_URL?>/resources/branches/jeju.jfif" alt="">
                                </div>
                            </div>
                            <div class="contents">
                        ...
                        <div class="map">
                            <!-- 마커 클릭 시 해당 지회 정보 표시 -->
                            <div class="marker busan active" onclick="showBranch(0)"></div>
                            <div class="marker yeosu" onclick="showBranch(1)"></div>
                            <div class="marker incheon" onclick="showBranch(2)"></div>
                            <div class="marker ulsan" onclick="showBranch(3)"></div>
                            <div class="marker pyeongtaek" onclick="showBranch(4)"></div>
                            <div class="marker masan" onclick="showBranch(5)"></div>
                            <div class="marker daesan" onclick="showBranch(6)"></div>
                            <div class="marker pohang" onclick="showBranch(7)"></div>
                            <div class="marker gunsan" onclick="showBranch(8)"></div>
                            <div class="marker mokpo" onclick="showBranch(9)"></div>
                            <div class="marker donghae" onclick="showBranch(10)"></div>
                            <div class="marker jeju" onclick="showBranch(11)"></div>
                        </div>
                    </div>
                </div>
                <div>
                    <div class="box-title">
                        <select onchange="selectBranchOption(event.target.value)">
                    ...
                    <div class="box-contents">
                        <div class="branchModal">
                            ...
                            <div class="contents">
                                <div class="phone">051-465-1651~4</div>
                                <div class="fax">051-463-1652</div>
                                <div class="address">[48943] 부산시 중구 충장대로 24,<br>201호 (구) 국제여객터미널</div>
                                <div class="site"><a>www.busanpilot.co.kr</a></div>
                            </div>
                        </div>
                        <div class="branchModal">
                        ...
                        <div class="map">
                            <!-- 마커 클릭 시 해당 지회 정보 표시 -->
                            <div class="marker busan" onclick="selectBranchOption(0)"></div>
                            <div class="marker yeosu" onclick="selectBranchOption(1)"></div>
                            <div class="marker incheon" onclick="selectBranchOption(2)"></div>
                            <div class="marker ulsan" onclick="selectBranchOption(3)"></div>
                            <div class="marker pyeongtaek" onclick="selectBranchOption(4)"></div>
                            <div class="marker masan" onclick="selectBranchOption(5)"></div>
                            <div class="marker daesan" onclick="selectBranchOption(6)"></div>
                            <div class="marker pohang" onclick="selectBranchOption(7)"></div>
                            <div class="marker gunsan" onclick="selectBranchOption(8)"></div>
                            <div class="marker mokpo" onclick="selectBranchOption(9)"></div>
                            <div class="marker donghae" onclick="selectBranchOption(10)"></div>
                            <div class="marker jeju" onclick="selectBranchOption(11)"></div>
                        </div>
                    </div>
                </div>
            </div>
