...
define('G5_NO_PROFILE_IMG', '<img src="'.G5_PUBLISH_URL.'/resources/images/user.png" alt="no_profile" width="'.$config['cf_member_icon_width'].'" height="'.$config['cf_member_icon_height'].'">');
