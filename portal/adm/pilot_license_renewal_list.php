...
$sql_common = " from {$g5['pilot_license_renewal_table']} ";
...
<form name="renewal_from" id="renewal_from" action="./pilot_license_renewal_list_update.php" onsubmit="return fmemberlist_submit(this);" method="post">
...
<div class="btn_fixed_top">
    ...
    <a href="./pilot_license_renewal_regi.php" id="renewal_add" class="btn btn_01">강의등록</a>
    <?php } ?>
</div>
