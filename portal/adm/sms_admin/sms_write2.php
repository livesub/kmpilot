...
<link rel="stylesheet" type="text/css" href="<?=G5_ADMIN_URL?>/sms_admin/css/sms.css">
...
<div class="contents">
            ...
            <form name="VisualPhone" id="VisualPhone" method="post" enctype="multipart/form-data" action="./sms_action.php" target="hiddenframe">
                ...
                <div class="sect-visualphone">
                    ...
                    <div class="btn-phone-area">
                        <!-- <a class="first" id="pb_btn" href="#">주소록<img alt="주소록" src="https://kmpilot.or.kr/CMS/_img/sms/btn_address.gif"></a>
                        <a id="paste_btn" href="#">비회원등록<img alt="붙여넣기" src="https://kmpilot.or.kr/CMS/_img/sms/btn_paste.gif"></a>
                        ...
                        <button id="pb_btn" type="button">주소록</button>
                        <button id="paste_btn" type="button">비회원등록</button>
                        <button id="imgadd_btn" type="button"><img src="./img/icon-plus.png" alt="">사진첨부</button>
                    </div>
                    <div class="phone-area">
                        <div class="btn-phone-controll">
                            ...
                            <button id="allnumdel_btn" type="button"><img src="./img/icon-minus.png" alt="">전체삭제</button>
                    ...
                    <div class="regphone-area">
                        ...
                        <div class="regphone-box">
                            <input name="s_reqphone" title="회신번호" id="s_reqphone" type="text" class="en" value="<?=$CFG['cms_sms_number']?>">
                ...
                <div class="btn-send-area">
                    ...
                    <button type="button" id="msg_send_btn">보내기</button>
                    <button type="button" id="msg_cancel_btn">새로쓰기</button>
                </div>

                <div class="send-type">즉시</div>
                <div class="msg-type" id="msg-type">SMS</div>
    ...
    <div class="ly-mms-file ly-div" style="display: none;">
        <strong class="tit-mms-file">사진첨부</strong>
        <div class="ly-wrap">
            <div class="desc">
                <p><strong class="en">1000*1000 / 500KB</strong><br>이미지까지 업로드 가능</p>
                <p><strong class="en">JPG</strong>만 업로드 가능</p>
                <p><strong>업로드된 이미지</strong>는<br>각 단말기 기종에따라 통신사에서<br>자동 리사이징된후 발송 됩니다</p>
            </div>
            <div class="input-area">
                <form name="upload_form" action="./sms_action.php" enctype="multipart/form-data" method="post" target="hiddenframe">
                    ...
                    <input name="img1" title="이미지첨부" id="img1" type="file" style="display:none;">
                    <label for="img1" class="image_uploader">파일 선택</label>
                </form>
            </div>
        </div>
        <!--<div class="btn-area">
    ...
    <div class="ly-paste ly-div">
        <strong class="tit-paste">비회원 등록하기</strong>
        <div class="ly-wrap">
            <div class="desc">
            ...
            <div class="btn-area">
                ...
                <button class="btn-paste" type="button">등록</button>
            </div>
        </div>
        <!-- <a class="btn-close" href="#"><img alt="닫기" src="https://kmpilot.or.kr/CMS/_img/sms/btn_close.gif"></a> -->
        <button class="btn-close" type="button">닫기</button>
