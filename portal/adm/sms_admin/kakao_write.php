...
?>
    ...
    <link rel="stylesheet" type="text/css" href="<?=G5_ADMIN_URL?>/sms_admin/css/kakao.css">
                    ...
                    <form name="VisualPhone" id="VisualPhone" method="post" enctype="multipart/form-data" action="./sms_action.php" target="hiddenframe">
                        ...
                        <div class="sect-visualphone">
                            ...
                            <div class="btn-phone-area">
                                ...
                                <button id="imgadd_btn" type="button"><img src="./img/icon-plus-kakao.png" alt="">사진첨부</button>
                            </div>
                        ...
                        <div class="msg-type" id="msg-type">카카오톡</div>
                    </form>
                </div>
