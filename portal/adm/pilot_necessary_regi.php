...
if ($w == '')
{
    ...
    $sql = " SELECT * FROM {$g5['pilot_necessary_table']} WHERE idx = {$idx} ";
...
<form name="renewal_from" id="renewal_from" action="./pilot_necessary_save.php" onsubmit="return renewal_submit();" method="post" enctype="multipart/form-data">
<input type="hidden" name="w" value="<?php echo $w ?>">
<input type="hidden" name="idx" value="<?php echo $idx ?>">

<div class="btn_fixed_top">
    <a href="./pilot_necessary_list.php?<?php echo $qstr ?>" class="btn btn_02">목록</a>
