...
{
    $html_title .= " 수정";
    $sql = " select * from {$g5['edu_new_win_table']} where nw_id = '$nw_id' ";
    $nw = sql_fetch($sql);
...
<form name="frmnewwin" action="./edu_newwinformupdate.php" onsubmit="return frmnewwin_check(this);" method="post">
...
function frmnewwin_check(f)
{
    ...
    check_field(f.nw_subject, "한글 제목을 입력하세요.");
